...
count = 0
label_dict = {0: 'demo',  1: 'lips', 2: 'open', 3: 'webex', 4: 'zoom'}
...
# tf.keras.layers. Conv3D(8, (3, 3, 3), activation='relu', input_shape=input_shape, kernel_regularizer=regularizers.l2(0.001)),
# tf.keras.layers.MaxPooling3D((2, 2, 2)),
# tf.keras.layers.Conv3D(32, (3, 3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.001)),
# tf.keras.layers.MaxPooling3D((2, 2, 2)),
# tf.keras.layers.Conv3D(256, (3, 3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.001)),
...
#
model.load_weights('/Users/sphoorthy/Desktop/Computer-Vision-Lip-Reading-2.0-main/training/model_weights6.h5')
...
while True:
    ...
    for face in faces:
        ...
        if lip_distance > 65: # person is talking
